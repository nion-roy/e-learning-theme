...
!(function (e) {
   ...
   var s,
      ...
      S,
      Z,
      F = '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.372-12 12 0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.405.042-3.441.218-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.655 2.568-.994 3.995-.283 1.194.599 2.169 1.777 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.398 2.967 7.398 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146 1.124.347 2.317.535 3.554.535 6.627 0 12-5.373 12-12 0-6.628-5.373-12-12-12z" fill-rule="evenodd" clip-rule="evenodd"/></svg>',
            ...
            this.each(function () {
               ...
               function ee() {
                  (z = U.data("gall")),
                     ...
                     "iframe" !== U.data("vbtype") &&
                        ...
                        "ajax" !== U.data("vbtype") &&
                        ((S = { pinterest: '<a target="_blank" href="https://pinterest.com/pin/create/button/?url=' + U.prop("href") + "&media=" + U.prop("href") + "&description=" + C + '">' + F + "</a>", facebook: '<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=' + U.prop("href") + '">' + G + "</a>", twitter: '<a target="_blank" href="https://twitter.com/intent/tweet?text=' + C + "&url=" + U.prop("href") + '">' + J + "</a>", linkedin: '<a target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=' + U.prop("href") + '">' + K + "</a>", download: '<a target="_blank" href="' + U.prop("href") + '">' + L + "</a>" }),
                        e.each(Q, function (e, s) {
                           o.append(S[s]);
                        })),
                     (g = k || e('.vbox-item[data-gall="' + z + '"]')).length < 2 && ((p = !1), (w = !1)),
                     (B = g.eq(g.index(U) + 1)),
                     (P = g.eq(g.index(U) - 1)),
                     B.length || !0 !== p || (B = g.eq(0)),
                     g.length >= 1 ? ((V = g.index(U) + 1), t.html(V + " / " + g.length)) : (V = 1),
                     !0 === w ? t.show() : t.hide(),
                     "" !== C ? c.show() : c.hide(),
                     B.length || !0 === p ? (e(".vbox-next").css("display", "block"), (M = !0)) : (e(".vbox-next").css("display", "none"), (M = !1)),
                     g.index(U) > 0 || !0 === p ? (e(".vbox-prev").css("display", "block"), (E = !0)) : (e(".vbox-prev").css("display", "none"), (E = !1)),
                     1 == x && (e(".vbox-prev, .vbox-next ").css("display", "none"), (E = !1)),
                     (!0 !== E && !0 !== M) || (n.on(ne.DOWN, re), n.on(ne.MOVE, le), n.on(ne.UP, de));
               }
               function ie(e) {
                  return (
                     !(e.length < 1) &&
                     ...
                     void n.animate({ opacity: 0 }, 500, function () {
                        _.css("background", y), n.removeClass("vbox-animated").removeClass("swipe-left").removeClass("swipe-right").css({ "margin-left": 0, "margin-right": 0 }), "iframe" == e.data("vbtype") ? ke() : "inline" == e.data("vbtype") ? ge() : "ajax" == e.data("vbtype") ? he() : "video" == e.data("vbtype") ? pe(s) : (n.html('<img src="' + v + '">'), me()), (U = e), ee(), (m = !1), ae.cb_after_nav(U, V, B, P);
                     }))
                  );
               }
               function te(e) {
               ...
               (se.VBclose = function () {
                  ...
                  U.on("click", function (k) {
                     ...
                     return (
                        (O += "</div>"),
                        (N = '<a class="vbox-next">' + ae.htmlNext + '</a><a class="vbox-prev">' + ae.htmlPrev + "</a>"),
                        (j = '<div class="vbox-title"></div><div class="vbox-left"><div class="vbox-num">0/0</div></div><div class="vbox-close">' + ae.htmlClose + "</div>"),
                        '<div class="vbox-share"></div>',
                        (l = '<div class="vbox-overlay ' + u + '" style="background:' + y + '">' + O + '<div class="vbox-container"><div class="vbox-content"></div></div>' + j + N + '<div class="vbox-share"></div></div>'),
                        e("body").append(l).addClass("vbox-open"),
                        e(".vbox-preloader div:not(.sk-circle) .sk-child, .vbox-preloader .sk-rotating-plane, .vbox-preloader .sk-rect, .vbox-preloader div:not(.sk-folding-cube) .sk-cube, .vbox-preloader .sk-spinner-pulse").css("background-color", ae.spinColor),
                        (_ = e(".vbox-overlay")),
                        (d = e(".vbox-container")),
                        (n = e(".vbox-content")),
                        (i = e(".vbox-left")),
                        ...
                        o.css(Z, "-1px"),
                        o.css({ color: ae.titleColor, fill: ae.titleColor, "background-color": ae.titleBackground }),
                        c.css(ae.titlePosition, "-1px"),
                        c.css({ color: ae.titleColor, "background-color": ae.titleBackground }),
                        e(".vbox-close").css({ color: ae.closeColor, "background-color": ae.closeBackground }),
                        i.css(ae.numerationPosition, "-1px"),
                        i.css({ color: ae.numerationColor, "background-color": ae.numerationBackground }),
                        e(".vbox-next span, .vbox-prev span").css({ "border-top-color": ae.arrowsColor, "border-right-color": ae.arrowsColor }),
                        n.html(""),
                        n.css("opacity", "0"),
                        _.css("opacity", "0"),
                        ee(),
               ...
               function fe() {
                  c.html(C),
                     n.find(">:first-child").addClass("vbox-figlio").css({ width: b, height: h, padding: r, background: a }),
               ...
               "ontouchstart" in window ? (e(document).on("touchstart", ue), e(document).on("touchmove", ue), e(document).on("touchend", ue)) : (e(document).on("mousedown", ve), e(document).on("mouseup", ve), e(document).on("mouseout", ve), e(document).on("mousemove", ve)),
